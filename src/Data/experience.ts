    ...
    projects: [
      {
        ...
        name: "Westfield Digital Parking",
        start: "2022-09",
        finish: "PRESENT",
        description: [
          "Scentregroup owns and operates Westfield shopping centres in Australia and New Zealand.",
          "The Digital and Data group looks after many customer facing and internal platforms and services.",
          "For example, westfield membership, website, gift card, parking etc.",
          "I joined as a Software Engineering Lead for this group.",
          "I have primarily been looking after the group's digital parking team.",
        ].join(" "),
        achievements: [
          "I have architected, aligned, lead development of, planned for and delivered new parking vendor integrations. This included designing and rolling out new vendor neutral REST (internal) and GraphQL (external) APIs to decrease development cost for onboarding new parking vendors and integrations.",
          "I have developed a carpark simulator to help the team test and develop new features without needing to be physically present at the carpark.",
          "I have modernised legacy tools written in Ruby on Rails to modern tech stack and architecture.",
          "I have deployed services to cloud functions and cloud run (serverless) to reduce day to day operational costs.",
          "I have played a key role in day to day planning, prioritisation and estimation of work. These included quarterly planning, sprint planning, feature planning, release planning etc.",
          "I have been supporting the day to day operations of the team and the group, helping keep the lights on.",
        ],
        technology: [
          "Auth0",
          "ChatGPT",
    ...
    projects: [
      {
        ...
        achievements: [
          "I transitioned into the engineering manager responsible for solution architecture, design, development, testing and operations of this team.",
          "I transitioned the business's large enterprise monolithic legacy spaghetti system developed over many years to a high scalability, high availability microservices architecture. I set up the framework for easier extensibility and helped add additional products and services into the new architecture to grow the business. I introduced tools and processes to help the business tackle its growing complexity.",
          ...
          "I developed, helped develop and worn whatever hat is necessary to facilitate the development of many new products and services in collaboration with the team, other internal teams and external partners. This includes the company's PM 54 Router, Dynamic DNS, Video Verification, RAPIDlink Router and Portal, Pocket Secure 2.0, 4G Upgrade program etc.",
